...
var Table = function (_React$Component) {
        ...
        _this.renderSelectionBox = function (type) {
            return function (_, record, index) {
                ...
                return React.createElement(
                    ...
                    React.createElement(SelectionBox, _extends({ type: type, store: _this.store, rowIndex: rowKey, onChange: handleChange, defaultSelection: _this.getDefaultSelection() }, props))
                );
            };
        };
    ...
    _createClass(Table, [{
            ...
            return treeMap(columns, function (column, i) {
                ...
                if (column.sorter) {
                    ...
                    sortButton = React.createElement(
                        ...
                        React.createElement(Icon, { className: prefixCls + '-column-sorter-up ' + (isAscend ? 'on' : 'off'), type: 'caret-up', theme: 'filled' }),
                        React.createElement(Icon, { className: prefixCls + '-column-sorter-down ' + (isDescend ? 'on' : 'off'), type: 'caret-down', theme: 'filled' })
                    );
                }
        ...
        value: function createComponents() {
            ...
            this.components = _extends({}, components, { body: _extends({}, components.body, { row: this.row }) });
        }
    }, {
        key: 'render',
