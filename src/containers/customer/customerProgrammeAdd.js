...
class customerDemandOrderAdd extends Component {
    constructor(props) {
        super(props)
        this.state = {
            productList: [],
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            values.customerProgramme = this.state.bindProductList
            values.order_num = this.state.order_num
            console.log(values)
            NetWork_Post('customerProgrammeAdd', values, (response) => {
                console.log(response, '12313')
...
export default Form.create()(customerDemandOrderAdd)